        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="e.g. Premium Leather Laptop Bag" required>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="sale_price" class="form-control" placeholder="79.00 (optional)">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="short_description" class="form-control" rows="2" placeholder="Brief summary of product features..."></textarea>
                </div>

                <div class="form-group">
                    <label class="font-weight-bold text-dark">Key Features / Highlights (One per line)</label>
                    <textarea name="features" class="form-control" rows="4" placeholder="• Active Noise Cancellation up to 35dB&#10;• 40-Hour Long Battery Life&#10;• Bluetooth 5.2 Wireless Connectivity"></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="specifications" class="form-control" rows="4" placeholder="Brand: Kagzi Audio&#10;Driver Size: 40mm&#10;Warranty: 1 Year Manufacturer Warranty"></textarea>
                </div>

                <div class="form-group">
                    <label class="font-weight-bold text-dark">Full Description</label>
                    <textarea name="description" class="form-control" rows="5" placeholder="Detailed product specifications, materials, warranty info..."></textarea>
                </div>
            </div>

        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="home-slider slide-animate owl-carousel owl-theme mb-2" data-owl-options="{
                    ...
                    <div class="home-slide home-slide1 banner banner-md-vw banner-sm-vw d-flex align-items-center" style="overflow: hidden; border-radius: 12px; background-color: #f7f3ed;">
                        <a href="<?= base_url('shop') ?>" class="w-100 h-100 d-block text-decoration-none">
                            <img class="slide-bg w-100 h-100" style="object-fit: cover !important; object-position: center !important; width: 100% !important; height: 100% !important; border-radius: 12px;" src="<?= base_url('assets/images/banners/home-slide-1.jpg') ?>" width="1024" height="571" alt="Home & Lifestyle Solutions: Clear Organization & Stylish Bags">
                        </a>
                    </div>

                    <div class="home-slide home-slide2 banner banner-md-vw banner-sm-vw d-flex align-items-center" style="overflow: hidden; border-radius: 12px; background-color: #f7f3ed;">
                        <a href="<?= base_url('shop') ?>" class="w-100 h-100 d-block text-decoration-none">
                            <img class="slide-bg w-100 h-100" style="object-fit: cover !important; object-position: center !important; width: 100% !important; height: 100% !important; border-radius: 12px;" src="<?= base_url('assets/images/banners/home-slide-2.jpg') ?>" width="1024" height="571" alt="Elevate Your Space: Sophisticated Storage & Travel Solutions">
                        </a>
                    </div>

                    <div class="home-slide home-slide3 banner banner-md-vw banner-sm-vw d-flex align-items-center" style="overflow: hidden; border-radius: 12px; background-color: #f7f3ed;">
                        <a href="<?= base_url('shop') ?>" class="w-100 h-100 d-block text-decoration-none">
                            <img class="slide-bg w-100 h-100" style="object-fit: cover !important; object-position: center !important; width: 100% !important; height: 100% !important; border-radius: 12px;" src="<?= base_url('assets/images/banners/home-slide-3.jpg') ?>" width="1024" height="571" alt="Streamline Your Life: Curated Home & Travel Essentials">
                        </a>
                    </div>
                </div>
